    ...
    <div class="w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-300 dark:border-gray-200">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            <div class="flex space-x-44">
                <a href="{{ route('login') }}" class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-gray-600">
                    Вход
                </a>
            ...
            <form class="space-y-4 md:space-y-6" action="{{ route('register_form') }}" method="post">
                @csrf
                <div>
                    <label for="email" class="block mb-2 text-sm font-medium  dark:text-gray-700">Имя</label>
                    <input type="text" name="name" id="email" class="bg-gray-50 sm:text-sm rounded-lg focus:ring-primary-600 block w-full p-2.5 dark:bg-gray-400 dark:placeholder-gray-800 dark:text-gray-700 dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                </div>
                <div>
                    <label for="email" class="block mb-2 text-sm font-medium  dark:text-gray-700">Фамилия</label>
                    <input type="text" name="last_name" id="email" class="bg-gray-50 sm:text-sm rounded-lg focus:ring-primary-600 block w-full p-2.5 dark:bg-gray-400 dark:placeholder-gray-800 dark:text-gray-700 dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                </div>
                <div>
